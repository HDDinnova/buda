<div id="foto3-1" class="videofull">
    <video id="video3-1fons" poster="video/pas_de_barca_ebre.jpg" preload>
...
<div id="foto3-2" class="videofull">
    <video id="video3-2fons" poster="video/pas_de_barca_migjorn.jpg" preload>
        <source src="video/pas_de_barca_migjorn.mp4" type="video/mp4">
        <source src="video/pas_de_barca_migjorn.ogg" type="video/ogg">
        <source src="video/pas_de_barca_migjorn.webm" type="video/webm">
    </video>
    <div class="col-lg-offset-7 col-md-offset-7" id="foto3-2text1">
        <strong class="taronga col-lg-8 col-md-8 pull-right">PAS DEL RIU MIGJORN</strong>
        <div class="clearfix"></div>
        <div class="blanc col-lg-12 col-md-12">
            <p>Al mes de novembre es sol obrir aquesta sortida sorrenca per part del Parc Natural del Delta, per pescar-hi l’angula que penetra endins des del mar.<br>Són espectaculars els canyissars que flanquegen la gola de Migjorn des d’on comença fins que arriba al mar, i en els que s’hi concentren molts anàtids i altres ocells aquàtics.</p>
            <div id="foto3-2boto" class="boto">
                <img class="taronga" src="img/play.png" alt="reproduir video">
            </div>
        </div>
    </div>
    <div class="tapa taronga">
