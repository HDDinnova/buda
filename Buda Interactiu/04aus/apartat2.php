<div id="foto2-1" class="fotofons">
    ...
    <p id="foto2-1peu" class="peu col-lg-offset-1 col-md-offset-1 col-sm-offset-1 col-xs-offset-1 col-lg-2 col-md-3 col-sm-4 col-xs-4">Foto: Salvador Maluquer</p>
    <div class="tapa negre"></div>
    <div id="foto2-1video" class="videofull">
        <video poster="video/SiscoVidal_importanciaOrnitolegs.jpg" preload>
            <source src="video/SiscoVidal_importanciaOrnitolegs.mp4" type="video/mp4">
            <source src="video/SiscoVidal_importanciaOrnitolegs.ogg" type="video/ogg">
            <source src="video/SiscoVidal_importanciaOrnitolegs.webm" type="video/webm">
        </video>
        <p class="videopeu groc col-lg-offset-1 col-md-offset-1 col-sm-offset-1 col-xs-offset-1 col-lg-3 col-md-3 col-sm-4 col-xs-4">L’actual director del Parc Natural del Delta de l’Ebre, Francesc Vidal, ressalta la importància ornitològica de l’illa de Buda i de tot el delta en conjunt.</p>
    </div>
</div>
<div id="foto2-2" class="fotofons">
    <div id="foto2-2text" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 col-lg-offset-1 col-md-offset-1 col-sm-offset-1 col-xs-offset-1">
        ...
        <div id="foto2-2botons" class="boto">
            ...
            <img id="foto2-2boto2" class="taronga" src="img/play.png" alt="reproduir video">
        </div>
    </div>
</div>