...
<div class="guardar">
    <img src="../img/save.png" alt="icona guardar" data-video="01pasbuda/video/CeciliaPrats_PasdeBarca" data-descripcio="Cecília Prats - Record del pas de Buda" onclick="guardarVideo(this)"/>
</div>
    <?php }
?>