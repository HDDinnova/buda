...
<video id="video3-2fons" poster="video/pas_de_barca_migjorn.jpg" loop preload>
...
<h2 class="groc" id="titul3-1">
    PAS DEL RIU EBRE
</h2>
<div class="groc" id="tapa3-1">
    <div class="col-md-8">
        <img src="img/marca2.png" alt="icona disseny"/>
        <p>Al llarg de la seva existència, els diversos propietaris de l’illa han hagut de salvar l’obstacle dels braços del riu Ebre que separen a l’illa de la resta del Delta.<br>El pas, de caràcter privat, era el darrer pas de barca que creuava l’Ebre, i va permetre un important moviment de persones i càrregues arran de la transformació d’erms de l’illa en camps d’arròs. Durant els mesos en quèhi havia més feina als arrossars els jornalers vivien en la mateixa illa, molts d’ells procedents de Deltebre.</p>
    </div>
</div>
<h2 class="taronga" id="titul3-2">
    PAS DEL RIU MIGJORN
</h2>
<div id="subtitul3-2">
    Al mes de novembre es sol obrir aquesta sortida sorrenca per part del Parc Natural del Delta, 
    per pescar-hi l’angula que penetra endins des del mar.<br>Són espectaculars els canyissars que 
    flanquegen la gola de Migjorn des d’on comença fins que arriba al mar, i en els que s’hi 
    concentren molts anàtids i altres ocells aquàtics.
    <div id="play3">
        <img id="transbordador" src="img/play.png" alt="reproduir video transbordador migjorn">
    </div>
</div>
<div class="taronga" id="tapa3-2">
    <div class="col-md-8">
        <img src="img/marca2.png" alt="icona disseny"/>
...
<div class="videopopup">
    <div id="videosapartat3"></div>
</div>
<script>
    $('#transbordador').on('click',function(){
        $('body').off('mousewheel');
        $('#videosapartat3').load('apartat3video.html',function(){
            $('.videopopup').show();
        });
