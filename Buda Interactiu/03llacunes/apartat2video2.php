...
<div class="guardar">
    <img src="../img/save.png" alt="icona guardar" data-video="01pasbuda/video/Sarro_calaixos_1" data-descripcio="El Calaix de Mar (o de Baix) i la part de les llacunes més propera a la mar.<br>Filmació: Artur Sarró (dècada de 1960)" onclick="guardarVideo(this)"/>
</div>
    <?php }
?>